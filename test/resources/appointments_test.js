...
describe('assistant-api', function(){
  ...
  var mock_resource = {"id":1,"artist-id":1,"customer-id":1,"date-scheduled":1440805389969,"description":"nerdy tattoo time"};
  var mock_update = {"id":1,"artist-id":1,"customer-id":1,"date-scheduled":1440805389969,"description":"jk"};
