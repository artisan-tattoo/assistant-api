...
describe('assistant-api', function(){
  var resource = "stores";
  var mock_resource = {"id":1,"password-hash":"$2a$10$aXQ3grX0WeOCoiaA9S0laOIsyBzTb7XPvGINLj4zt29o6MNvKuWLi","name":"test store","email":"store@example.com"};
  var mock_update = {"id":1,"password-hash":"$2a$10$aXQ3grX0WeOCoiaA9S0laOIsyBzTb7XPvGINLj4zt29o6MNvKuWLi","name":"store test","email":"store@example.com"};
