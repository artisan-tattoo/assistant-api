...
describe('assistant-api', function(){
  ...
  var mock_resource = <%= JSON.stringify(fixtures.mock_resource) %>;
  var mock_update = <%= JSON.stringify(fixtures.mock_update) %>;
  var update_attr = <%= JSON.stringify(fixtures.update_attr) %>;
